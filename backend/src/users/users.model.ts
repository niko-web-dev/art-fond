...
export class User extends Model<User, UserCreationAttrs> {
  ...
  @ApiProperty({ example: 'test123', description: 'name user' })
  @Column({ type: DataType.STRING, allowNull: false })
  name: string;

  @ApiProperty({ example: 'test123', description: 'surname user' })
  @Column({ type: DataType.STRING, allowNull: false })
  surname: string;
  ...
  @ApiProperty({
    example: '[{"phone": "+78005553535"}]',
    description: 'Array contacts user',
  })
  @Column({ type: DataType.ARRAY(DataType.TEXT), allowNull: false })
  contacts: string[];

  @ApiProperty({
    example: '[{"school": "Moscow city, school 17"}]',
    description: 'Array education user',
  })
  @Column({ type: DataType.ARRAY(DataType.TEXT), allowNull: false })
  education: string[];
  ...
  @ApiProperty({
    example: 'lorem ipsum',
    description: 'info for education user',
  })
  ...
  @ApiProperty({
    example: '2021-07-27T19:53:09.152Z',
    description: 'Birghday user, format ISO string',
  })
  @Column({ type: DataType.STRING, allowNull: false })
  birthday: string;
